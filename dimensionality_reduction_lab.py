...
plt.savefig("Logistic Regression on PCA.png")
plt.show()
...
plt.tight_layout()
plt.savefig("Logistic Regression on LDA.png")
plt.show()
...
plt.tight_layout()
plt.savefig("RBF Kernel PCA.png")
plt.show()
...
plt.tight_layout()
plt.savefig("RBF Kernel PCA Classes.png")
plt.show()
